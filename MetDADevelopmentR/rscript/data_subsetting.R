...
fwrite(result, "data_subsetting.csv", col.names = TRUE)
# summary_data = data.table(index = 1:nrow(iris), iris)
# fwrite(summary_data, "data_subsetting.csv", col.names = TRUE)
...
#
#   report_data_subsetting(project_id, fold_id)
#
#
#   filename = "report_data_subsetting"
#   suffix = '.docx'
#
#
#
