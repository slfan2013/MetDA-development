...
fwrite(result, "mann_whitney_test.csv", col.names = TRUE)
# summary_data = data.table(index = 1:nrow(iris), iris)
# fwrite(summary_data, "mann_whitney_test.csv", col.names = TRUE)
...
#
#   fold_id = paste0("Mann-Whitney U test", temp_time)
#   data1_id = "mann_whitney_test.csv"
#
#
...
#
#   report_mann_whitney_test(project_id, fold_id)
#
#
#   filename = "report_mann_whitney_test"
#   suffix = '.docx'
#
#
#
