...
f = read.csv(paste0("http://metda:metda@localhost:5985/metda_project/",project_id,"/f.csv"))
p = read.csv(paste0("http://metda:metda@localhost:5985/metda_project/",project_id,"/p.csv"))
e = data.matrix(read.csv(paste0("http://metda:metda@localhost:5985/metda_project/",project_id,"/e.csv")))[,-1]
