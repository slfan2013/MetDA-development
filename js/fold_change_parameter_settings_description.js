console.log("fold_change_parameter_settings_description.js")
...
get_parameter_description = function(){
    ...
    ocpu.call("call_fun",{parameter:{
        ...
        treatment_group_levels:parameter.treatment_group_levels,
        mean_or_median:parameter.mean_or_median,
